...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of HTCategoryKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhanglianjiang/HTCategoryKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhanglianjiang' => 'zhanglianjaing@hoteamsoft.com' }
  s.source           = { :git => 'https://github.com/zhanglianjiang/HTCategoryKit.git', :tag => s.version.to_s }
